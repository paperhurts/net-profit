...
- The snook: the first fish taken on a line, from a boat tied up south of the Ten Cent Bridge when the light is low, at ten coins a cast. One cast in ten lands one, one in fifty is big enough to keep and hangs on the hut, and the rest end with "The snook is still under the bridge." It shakes its head before every run, and a word over the tension bar says Pull or Ease off (2026-09-24, after the owner found it could not be caught). The roadmap entry has the whole of it.
...
- **Snook, for the owner's dad.** Built 2026-09-19, his birthday. The first fish taken on a line, in fishing/snook.ts. Silver, a black line down its side, yellow fins. It holds in the shadow of the Ten Cent Bridge's far abutment at dusk, night and dawn; a net towed over it finds nothing but a splash. Tie up within 170 of the spot on the south side, all but stopped, and a Cast button appears: ten coins a cast, which is how the bridge earns its name. The boat holds still and the stick works the rod: pull when it sulks, ease off when it runs. Pull through a run and the line parts; pull too little and it reaches the piling. Before every run but the first it shakes its head for 0.45 seconds, throwing spray, with three ticks of the reel, and the word over the tension bar turns from Pull to Ease off; it still pulls like a sulk while it does. That tell was added 2026-09-24, when the owner reported the snook could not be caught, and she was right: the fight had only been played by a test hand that eased off on the very frame a run began. A thumb a third of a second late, through the game's stick smoothing, pulled through the start of every run, the line ratcheted tighter each cycle, and it parted before the fish tired. It landed one short in two hundred and no giants; in the real game a hand that late lost five landable fish of five to the line. The hooked fish is drawn on the line from the abutment to the boat, as far out as it has been let run, not at a fixed spot south of the abutment, where it sat under the hull for most of the fight. The honest part, and the owner's numbers: every cast decides before the strike what is on the line. One in ten is a snook that can be landed, and most of those are shorts (18 to 27 inches) that go back; one in fifty is inside the slot (28 to 32) and big enough to keep, and goes up on the hut's wall; one keeper in five is the giant, Grampy's Snook (40 to 46), over the slot, which goes back after the photo and hangs as a gilt frame beside the mount, an Easter egg with its own guide page once landed. On every other cast the snook makes a last run no rod could stop. The tests play it with a person: everything reaches the thumb a third of a second late, the grip is never exact, and the rod follows the stick as it does in the game. That hand lands every landable short and keeper and about nine giants in ten; half a second late it still lands every short and keeper and three giants in five; the same hand that waits for the run instead of the tell loses more than half its shorts, so reading the tell is the skill. The giant runs at 36 (was 34, the reel's own speed) so that it stays the one that gets away; at 37 the careful hand lands about five in six, which is what this entry used to promise, but a slow hand only one in two. A heavy hand always parts the line and a timid one always loses it to the piling; a test of twenty thousand casts by that person holds the odds. Every miss ends the same way: "The snook is still under the bridge." The bridge is named for one the owner's family crossed to reach the beach.
