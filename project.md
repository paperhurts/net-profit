...
- Pets: the dog comes with the tree platform, potters on the pier between the root and the crates, and when the pirate sails in it runs to the end of the planks and barks for four seconds: the early warning, with a toast at most once a minute. Its shape is a stand-in until the kid's drawing.
