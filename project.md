...
- The snook: the first fish taken on a line, from a boat tied up south of the Ten Cent Bridge when the light is low, at ten coins a cast. One cast in ten lands one, one in fifty is big enough to keep and hangs on the hut, and the rest end with "The snook is still under the bridge." The roadmap entry has the whole of it.
