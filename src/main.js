...
const MAXLV = 5;
const NETW  = [52, 68, 88, 112, 140, 170];
const HOLD  = [12, 20, 32, 50, 80, 120];
const SPEED = [175, 205, 240, 275, 315, 350];
const COST  = {net:[8,20,45,100,220], hold:[6,16,40,90,200], engine:[10,25,60,130,280]};
const SPECIES = [
  {name:'sardine',     pl:'sardines',    v:1,  c:'#DCEBEE', s:6,   fat:.40, tail:.8},
  {name:'mackerel',    pl:'mackerel',    v:2,  c:'#6FC3D6', s:8,   fat:.34, tail:.85, mark:'#2C5F7C'},
  {name:'snapper',     pl:'snapper',     v:4,  c:'#FF8E7E', s:8.5, fat:.52, tail:.8},
  {name:'pufferfish',  pl:'pufferfish',  v:6,  c:'#F1D77A', s:6.5, fat:.86, tail:.5,  mark:'#B98F3A', dot:true},
  {name:'tuna',        pl:'tuna',        v:9,  c:'#2C4A7C', s:13,  fat:.40, tail:.95, mark:'#9FB6D9'},
  {name:'goldfin',     pl:'goldfin',     v:14, c:'#FFD24A', s:9,   fat:.45, tail:.9},
  {name:'lanternfish', pl:'lanternfish', v:22, c:'#7CF5E6', s:6.5, fat:.45, tail:.7,  mark:'#FFFFFF', dot:true, glow:true},
  {name:'shark',       pl:'sharks',      v:40, c:'#7D8C9A', s:12,  fat:.35, tail:1},
  {name:'moonfish',    pl:'moonfish',    v:10, c:'#B9A6FF', s:8,   fat:.58, tail:.8,  mark:'#FFFFFF', dot:true, glow:true},
  {name:'starfin',     pl:'starfin',     v:18, c:'#8CFFB0', s:8.5, fat:.40, tail:.95, mark:'#FFFFFF', dot:true, glow:true},
  {name:'sunrise koi', pl:'sunrise koi', v:60, c:'#FFB36B', s:14,  fat:.45, tail:1.1, rare:true},
  {name:'dusk ray',    pl:'dusk rays',   v:90, c:'#E58CFF', s:15,  fat:.72, tail:.6,  rare:true}
];
const RING_R = [560, 900, 1260, 1620, 1960, 2280, 2850];
const RANGE = [1150, 1600, 2000, 2400, 2900, 1e9];
const DAY_LEN = 300;
const SHARK = 7;
const STAGES = [
...
const TIER_NAME  = ['dinghy','skiff','cutter','trawler','seiner','flagship'];
const TIER_SCALE = [1, 1.1, 1.2, 1.32, 1.45, 1.6];
const PAINTS = [
...
const PIRATE_UNLOCK = 60, PIRATE_SPEED = 188;
const C = {
